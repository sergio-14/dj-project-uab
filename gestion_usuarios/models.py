...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    imagen = CloudinaryField('image', null=True, blank=True)  # Cambiado a CloudinaryField
    ...
    firma = CloudinaryField('image', null=True, blank=True)  # Cambiado a CloudinaryField
